...
if __name__ == "__main__":
	...
	#   tensorboard --logdir model/experimental_retrain_logs/
	# or:
	# 	python -m tensorboard.main --logdir=model/experimental_retrain_logs
	# open Tensorboard in browser:
	#   http://127.0.0.1:6006

	# load config
	config_path = _get_full_path("experimental_training_config.json")
	...
	train_writer = tf.summary.FileWriter(_get_full_path("model", "experimental_retrain_logs", "experimental_train"), sess.graph)
	validation_writer = tf.summary.FileWriter(_get_full_path("model", "experimental_retrain_logs", "validation"))
	...
	# save graph.pbtxt
	tf.train.write_graph(sess.graph_def, _get_full_path("model", "experimental_train"), "graph.pbtxt")
	checkpoint_path = _get_full_path("model", "experimental_train", "model.ckpt")
